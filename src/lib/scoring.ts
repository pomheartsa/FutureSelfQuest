...
const classProfiles: Record<RpgStatKey, ClassProfile> = {
  STR: {
    ...
    title: "Knight",
    titleTh: "ไนท์",
    tagline: "แนวหน้าผู้ล็อกเป้าหมาย คุมจังหวะ และพางานไปจนจบ",
    description: "คุณคือไนท์ผู้บุกทะลวงแนวหน้า เด่นเรื่องวินัย การจัดการตัวเอง และการยืนหยัดกับเป้าหมายจนสำเร็จ ทีมมักมองว่าคุณคือคนที่ไว้ใจได้ที่สุดเมื่อสถานการณ์ต้องการความแน่นอนและแรงขับเคลื่อน"
  },
  AGI: {
    key: "AGI",
    title: "Assassin",
    titleTh: "แอสซาซิน",
    tagline: "เงาผู้ปรับตัวไว เห็นทางเลือก และกล้าลองเส้นทางใหม่",
    description: "คุณคือแอสซาซินผู้เคลื่อนไหวรวดเร็ว ปรับตัวได้ดีเมื่อบริบทเปลี่ยน ชอบเรียนรู้สิ่งใหม่และเชื่อมมุมมองข้ามวัฒนธรรมโดยไม่ยึดติดกับวิธีเดิม เหมาะกับภารกิจที่ต้องความคล่องตัวสูง"
  },
  VIT: {
    key: "VIT",
    title: "Crusader",
    titleTh: "ครูเซเดอร์",
    tagline: "โล่ของทีมผู้ตั้งหลักไว รับแรงกดดันได้ และรักษาหลักการ",
    description: "คุณคือครูเซเดอร์ผู้ถือโล่ให้ทีม แกนในแข็งแรง รับผิดชอบต่อการตัดสินใจ และกลับมายืนได้เสมอเมื่อเจอสถานการณ์ยาก เหมาะกับบทบาทที่ต้องยึดมาตรฐานและปกป้องแนวทางของทีม"
  },
  INT: {
    key: "INT",
    title: "Wizard",
    titleTh: "วิซาร์ด",
    tagline: "จอมเวทผู้อ่านเกมขาด จับแพตเทิร์นไว และแปลงเป็นไอเดีย",
    description: "คุณคือวิซาร์ดผู้มองทะลุสนามรบ เด่นเรื่องการเข้าใจอารมณ์ ความคิด และข้อมูลรอบตัว มักช่วยทีมด้วยการเห็นภาพรวมและตั้งคำถามที่ทำให้ทางเลือกชัดขึ้นก่อนปล่อยหมัดเด็ด"
  },
  DEX: {
    key: "DEX",
    title: "Hunter",
    titleTh: "ฮันเตอร์",
    tagline: "พลแม่นธนูผู้อ่านคนขาด เชื่อมมุมมอง และยิงตรงประเด็น",
    description: "คุณคือฮันเตอร์สายตาคม ถนัดจับสัญญาณทางสังคม เข้าใจความแตกต่างของผู้คน และเลือกจังหวะสื่อสารได้แม่นยำ เหมาะกับงานที่ต้องประสานคนหลายแบบให้เดินไปทางเดียวกัน"
  },
  LUK: {
    key: "LUK",
    title: "Priest",
    titleTh: "พรีสต์",
    tagline: "ผู้เติมพลังทีม ชวนคนขยับ และทำให้ปาร์ตี้อยากไปต่อ",
    description: "คุณคือพรีสต์ผู้บัฟทีม มีเสน่ห์ด้านการสร้างพลังร่วม แบ่งปันเครดิต และช่วยให้คนรอบตัวรู้สึกมีแรง เหมาะกับบทบาทที่ต้องประคองบรรยากาศและโมเมนตัมของปาร์ตี้ให้ไปถึงเป้าหมาย"
  }
};
