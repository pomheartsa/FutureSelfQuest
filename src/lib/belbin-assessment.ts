...
export const belbinRoles: BelbinRole[] = [
  {
    id: "SH",
    titleTh: "ผู้ผลักดันสู่ความสำเร็จ",
    titleEn: "Shaper",
  ...
  {
    id: "PL",
    titleTh: "นักสร้างสรรค์จินตนาการ",
    titleEn: "Plant",
  ...
  {
    id: "CF",
    titleTh: "ผู้ใส่ใจรายละเอียด มีมาตรฐานสูง",
